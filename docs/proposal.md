...
This has [previously been done on TinyTapeout](https://tinytapeout.com/chips/ttihp26a/tt_um_spongent88). This implementation took 2x2 cells though. According to the paper, SPONGENT-88 can be implemented with 738 GE. According to [some people on the TT Discord server](https://discord.com/channels/1009193568256135208/1509616280993533982/1510065328191967393), one cell is ~1000 GE, so it should theoretically be possible to fit SPONGENT-88 on one cell.
